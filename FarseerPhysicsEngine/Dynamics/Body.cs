...
using FarseerPhysicsEngine.Collision;
using FarseerPhysicsEngine.Collision.Shapes;
using FarseerPhysicsEngine.Common;
using FarseerPhysicsEngine.Common.PhysicsLogic;
using FarseerPhysicsEngine.Controllers;
using FarseerPhysicsEngine.Dynamics.Contacts;
using FarseerPhysicsEngine.Dynamics.Joints;
using Microsoft.Xna.Framework;
using System;
using System.Collections.Generic;
using System.Diagnostics;

namespace FarseerPhysicsEngine.Dynamics
{
    /// <summary>
    /// The body type.
    /// </summary>
