...
namespace XNAPacMan
{
    ...
    public class GameLoop : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        // DRAWING
        private Dictionary<string, Texture2D> bonus_;

        private Texture2D xlife_;
        private Texture2D board_;
        private Texture2D boardFlash_;
        private Texture2D crump_;
        private Texture2D ppill_;
        private SpriteFont scoreFont_;
        private SpriteFont scoreEventFont_;
        private SoundBank soundBank_;
        private GraphicsDeviceManager graphics_;
        private SpriteBatch spriteBatch_;

        // LOGIC
        private List<Ghost> ghosts_;

        private Player player_;
        private TimeSpan lockTimer_;
        private DateTime eventTimer_;
        private int bonusSpawned_;
        private bool bonusPresent_;
        private DateTime bonusSpawnedTime_;
        private Dictionary<string, int> bonusEaten_;
        private bool playerDied_;
        private bool paChomp_;
        private int xlives_;
        private int score_;
        private int eatenGhosts_;
        private List<ScoreEvent> scoreEvents_;
