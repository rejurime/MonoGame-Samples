...
namespace XNAPacMan
{
    ...
    public class Player
    {
        ...
        private void RenderSprite(Texture2D spriteSheet, Rectangle? rectangle, Vector2 boardPosition, Vector2 position)
        {
        ...
        private void TryTurn(Keys input)
        {
        ...
        private void DoTurn(Keys newDirection)
        {
            switch (newDirection)
            {
                case Keys.Up:
        ...
        private Game game;
        private TimeSpan timer_;
        private SpriteBatch spriteBatch_;
        private Texture2D dyingFrames_;
        private Texture2D[] eatingFrames_;
        private int[] usedFramesIndex_;
