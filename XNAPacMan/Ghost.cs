...
namespace XNAPacMan
{
    ...
    public class Ghost
    {
        ...
        private Direction FindDirection(Point destination)
        {
        ...
        private Tile NextTile(Direction d)
        {
        ...
        private bool IsAJunction(Point tile)
        {
        ...
        private void RenderSprite(Texture2D spriteSheet, Rectangle? rectangle, Vector2 boardPosition, Vector2 position, Color color)
        {
        ...
        private Ghosts identity_;
        private Direction direction_;
        private Position position_;
        private GhostState state_;
        private GhostState previousState_;
