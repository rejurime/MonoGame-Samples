...
namespace CollisionSample
{
    ...
    public class CollisionSample : Microsoft.Xna.Framework.Game
    {
        ...
        private BoundingOrientedBox primaryOBox;
        private BoundingSphere primarySphere;
        private Ray primaryRay;

        // Secondary shapes.
        private Triangle[] secondaryTris = new Triangle[NumGroups];

        private BoundingSphere[] secondarySpheres = new BoundingSphere[NumGroups];
        private BoundingBox[] secondaryAABoxes = new BoundingBox[NumGroups];
        private BoundingOrientedBox[] secondaryOBoxes = new BoundingOrientedBox[NumGroups];

        // Collision results
        private ContainmentType[,] collideResults = new ContainmentType[NumGroups, NumSecondaryShapes];

        private Vector3? rayHitResult;

        // Camera state
        private Vector3[] cameraOrigins = new Vector3[NumGroups];

        private int currentCamera;

        private bool cameraOrtho;
        ...
        private void DrawPrimaryShapes()
        {
