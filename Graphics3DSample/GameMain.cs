...
using Graphics3DSample.Buttons;
using Graphics3DSample.Models;
...
namespace Graphics3DSample
{
    ...
    public class Graphics3DSampleGame : Microsoft.Xna.Framework.Game
    {
        ...
        private Checkbox[] lightEnablingButtons;
        private Checkbox perpixelLightingButton;
        private Checkbox animationButton;

        private Checkbox backgroundTextureEnablingButton;

        private float cameraFOV = 45; // Initial camera FOV (serves as a zoom level)
        private float rotationXAmount = 0.0f;
        private float rotationYAmount = 0.0f;
        ...
        private Animation.Animation CreateAnimation()
        {
            ...
            return new Animation.Animation(texture, frameSize, sheetSize, frameInterval);
        }
