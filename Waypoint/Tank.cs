...
namespace Waypoint
{
    ...
    public class Tank : DrawableGameComponent
    {
        ...
        /// </summary>
        private const float atDestinationLimit = 1f;
        ...
        private const float maxAngularVelocity = MathHelper.Pi;
        ...
        private const float maxMoveSpeedDelta = maxMoveSpeed / 2;
