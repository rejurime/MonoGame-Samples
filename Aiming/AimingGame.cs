...
namespace Aiming
{
    ...
    public class AimingGame : Game
    {
        ...
        private const float CatSpeed = 10.0f;

        // how fast can the spot light turn? this is in terms of radians per frame.
        private const float SpotlightTurnSpeed = 0.025f;
        ...
        private Vector2 spotlightPosition = new Vector2();

        // the origin of the spotlightTexture. The spotlight will rotate around this
        // point.
        private Vector2 spotlightOrigin = new Vector2();
