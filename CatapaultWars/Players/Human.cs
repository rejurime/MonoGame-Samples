...
namespace CatapaultGame.Players
{
    internal class Human : Player
    {
        ...
        private GestureSample? prevSample;

        private GestureSample? firstSample;

        public bool isDragging { get; set; }

        // Constant for longest distance possible between drag points
        private readonly float maxDragDelta = (new Vector2(480, 800)).Length();

        // Textures & position & spriteEffects used for Catapult
        private Texture2D arrow;

        private float arrowScale;
        private Vector2 catapultPosition = new Vector2(140, 332);
        ...
        private Vector2? firstMouseSample = null;
        private Vector2? prevMouseSample = null;
