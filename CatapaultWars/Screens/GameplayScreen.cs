...
namespace CatapaultGame.Screens
{
    internal class GameplayScreen : GameScreen
    {
        ...
        private Texture2D ammoTypeTexture;
        private Texture2D windArrowTexture;
        private Texture2D defeatTexture;
        private Texture2D victoryTexture;
        private SpriteFont hudFont;

        // Rendering members
        private Vector2 cloud1Position;

        private Vector2 cloud2Position;

        private Vector2 playerHUDPosition;
        private Vector2 computerHUDPosition;
        private Vector2 windArrowPosition;
        ...
        private const int minWind = 0;
        private const int maxWind = 10;
        ...
        #endregion Content Loading/Unloading
        ...
        /// </summary>
        private void DrawComputer(GameTime gameTime)
        {
            if (!gameOver)
