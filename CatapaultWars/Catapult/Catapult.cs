...
using Microsoft.Xna.Framework.Graphics; //using Microsoft.Devices;
using System;
...
namespace CatapaultGame.Catapult
{
    ...
    #endregion Catapult states definition enum
    ...
    public class Catapult : DrawableGameComponent
    {
        ...
        private CatapultGame curGame = null;
        ...
        private Dictionary<string, int> splitFrames;
        ...
        private string idleTextureName;
        private bool isAI;
        ...
        private CatapultState lastUpdateState = CatapultState.Idle;

        // Used to stall animations
        private int stallUpdateCycles;
        ...
        #endregion Variables/Fields and Properties
