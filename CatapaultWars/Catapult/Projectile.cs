...
namespace CatapaultGame.Catapult
{
    internal class Projectile : DrawableGameComponent
    {
        ...
        private Vector2 projectileVelocity = Vector2.Zero;

        private float projectileInitialVelocityY;
        private Vector2 projectileRotationPosition = Vector2.Zero;
        ...
        private Vector2 projectilePosition = Vector2.Zero;
