...
namespace ReachGraphicsDemo
{
    ...
    public class DemoGame : Microsoft.Xna.Framework.Game
    {
        ...
        private const float ZoomyTextLifespan = 0.75f;
        ...
        private RenderTarget2D transitionRenderTarget;
        ...
        private static List<ZoomyText> zoomyTexts = new List<ZoomyText>();
        ...
        /// </summary>
        private void BeginTransition(int oldMenuIndex, int newMenuIndex)
        {
        ...
        /// </summary>
        private void DrawOpenCurtainsTransition(float alpha)
        {
        ...
        /// </summary>
        private void DrawSpinningSquaresTransition(float mu, float alpha)
        {
        ...
        /// </summary>
        private void DrawChequeredAppearTransition(float mu)
        {
            Random random = new Random(23);
        ...
        /// </summary>
        private void DrawFallingLinesTransition(float mu)
        {
            Random random = new Random(23);
        ...
        /// </summary>
        private void DrawShrinkAndSpinTransition(float mu, float alpha)
        {
        ...
        /// </summary>
        private static void UpdateZoomyText(GameTime gameTime)
        {
            int i = 0;
