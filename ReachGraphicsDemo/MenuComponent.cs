...
namespace ReachGraphicsDemo
{
    ...
    internal class MenuComponent : DrawableGameComponent
    {
        ...
        private int touchSelection = -1;

        private static TimeSpan attractTimer;
        private static MouseState lastInputState = new MouseState(-1, -1, -1, 0, 0, 0, 0, 0);
        ...
        /// </summary>
        private void HandleTouchDown(int touchX, int touchY)
        {
        ...
        /// </summary>
        private void HandleAttractMode(GameTime gameTime, MouseState input)
        {
