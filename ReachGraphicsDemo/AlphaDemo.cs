...
namespace ReachGraphicsDemo
{
    ...
    /// </summary>
    internal class AlphaDemo : MenuComponent
    {
        // Fields.
        ...
        /// </summary>
        private void DrawTankIntoRenderTarget(Matrix tankRotation, Matrix sceneRotation)
        {
        ...
        /// </summary>
        private void DrawImposterSprites(Matrix tankRotation, Matrix sceneRotation, Vector3 cameraPosition, Vector3 cameraTarget, Matrix view, Matrix projection)
        {
            const int start = -2;
            const int end = 3;
