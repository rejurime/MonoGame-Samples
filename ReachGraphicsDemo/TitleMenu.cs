...
namespace ReachGraphicsDemo
{
    ...
    /// </summary>
    internal class TitleMenu : MenuComponent
    {
        // Constants.
        private const float XnaSpawnRate = 1.5f;

        private const float XnaLifespan = 7;

        // Fields.
        private int attractCycle;
        ...
        private List<FloatingXna> floatingXnas = new List<FloatingXna>();
