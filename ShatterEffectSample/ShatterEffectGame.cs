...
namespace ShatterEffectSample
{
    ...
    public class ShatterEffectGame : Microsoft.Xna.Framework.Game
    {
        ...
        private Vector3 lightPosition = Vector3.UnitY;
        private Vector4 ambientColor = Color.DarkGray.ToVector4();
        private Vector4 diffuseColor = Color.White.ToVector4();
        private Vector4 specularColor = Color.White.ToVector4();
        private float specularPower = 50;

        private float time;

        private const float translationRate = 50;
        private const float rotationRate = MathHelper.Pi * 3;
        ...
        private Vector3 cameraPosition = new Vector3(-696, 429, 835);
        private Vector3 targetPosition = new Vector3(0, 60, 0);
