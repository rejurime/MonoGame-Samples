...
namespace Flood_Control
{
    ...
    public class Game1 : Game
    {
        ...
        private Vector2 scorePosition = new Vector2(605, 215);

        private Vector2 gameBoardDisplayOrigin = new Vector2(70, 89);
        ...
        private Rectangle EmptyPiece = new Rectangle(1, 247, 40, 40);

        private const float MinTimeSinceLastInput = 0.25f;
        private float timeSinceLastInput = 0.0f;

        private Queue<ScoreZoom> ScoreZooms = new Queue<ScoreZoom>();

        private Vector2 gameOverLocation = new Vector2(200, 260);
        private float gameOverTimer;

        private const float MaxFloodCounter = 100.0f;
        private float floodCount = 0.0f;
        private float timeSinceLastFloodIncrease = 0.0f;
        private float timeBetweenFloodIncreases = 1.0f;
        private float floodIncreaseAmount = 0.5f;

        private const int MaxWaterHeight = 244;
        private const int WaterWidth = 297;

        private Vector2 waterOverlayStart = new Vector2(85, 245);
        private Vector2 waterPosition = new Vector2(478, 338);

        private int currentLevel = 0;
        private int linesCompletedThisLevel = 0;

        private const float floodAccelerationPerLevel = 0.5f;

        private Vector2 levelTextPosition = new Vector2(512, 215);
