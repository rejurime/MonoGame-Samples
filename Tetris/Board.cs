...
namespace Tetris
{
    internal class Board : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        private readonly Vector2 StartPositionForNewFigure = new Vector2(3, 0);
        private Vector2 PositionForDynamicFigure;
        private Vector2[] DynamicFigure = new Vector2[BlocksCountInFigure];
