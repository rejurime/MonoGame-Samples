...
namespace Primitives
{
    ...
    public class PrimitivesSampleGame : Microsoft.Xna.Framework.Game
    {
        ...
        // starts up.
        private const int NumStars = 500;

        // what percentage of those stars will be "big" stars? the default is 20%.
        private const float PercentBigStars = .2f;

        // how bright will stars be?  somewhere between these two values.
        private const byte MinimumStarBrightness = 56;

        private const byte MaximumStarBrightness = 255;

        // how big is the ship?
        private const float ShipSizeX = 10f;

        private const float ShipSizeY = 15f;
        private const float ShipCutoutSize = 5f;

        // the radius of the sun.
        private const float SunSize = 30f;
