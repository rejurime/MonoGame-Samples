...
namespace ShadowMapping
{
    ...
    public class ShadowMappingGame : Microsoft.Xna.Framework.Game
    {
        ...
        private Vector3 cameraPosition = new Vector3(0, 70, 100);

        private Vector3 cameraForward = new Vector3(0, -0.4472136f, -0.8944272f);
        private BoundingFrustum cameraFrustum = new BoundingFrustum(Matrix.Identity);

        // Light direction
        private Vector3 lightDir = new Vector3(-0.3333333f, 0.6666667f, 0.6666667f);
        ...
        private Model dudeModel;

        private float rotateDude = 0.0f;
        ...
        private void DrawModel(Model model, bool createShadowMap)
        {
