...
namespace PerformanceMeasuring
{
    ...
    public class PerformanceMeasuringGame : Game
    {
        ...
        private const int maximumNumberOfSpheres = 200;
        ...
        private const float worldSize = 20f;

        // A model for our ground
        private Model ground;

        // An array of spheres and the number of currently active spheres
        private Sphere[] spheres = new Sphere[maximumNumberOfSpheres];

        private int activeSphereCount = 50;

        // Are we colliding the spheres against each other?
        private bool collideSpheres = true;

        // Various input states for changing the simulation
        private GamePadState gamePad, gamePadPrev;

        private KeyboardState keyboard, keyboardPrev;
