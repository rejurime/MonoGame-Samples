...
namespace ChaseAndEvade
{
    ...
    public class ChaseAndEvadeGame : Game
    {
        ...
        private const float MouseEvadeDistance = 200.0f;
        ...
        private const float MouseHysteresis = 60.0f;
        ...
        private Vector2 tankWanderDirection;
        private Texture2D catTexture;
        private Vector2 catTextureCenter;
        private Vector2 catPosition;
        private Texture2D mouseTexture;
        private Vector2 mouseTextureCenter;
        private Vector2 mousePosition;
        private MouseAiState mouseState = MouseAiState.Wander;
        private float mouseOrientation;
        private Vector2 mouseWanderDirection;
